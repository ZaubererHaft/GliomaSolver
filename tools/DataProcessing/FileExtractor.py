...
def main():
   ...
   if len(sys.argv) <= 2:
      logger.error("Missing argument; 1: Base Path to patient folder, 2: nifti impl (1: simpleITK, else: nibabel)")
      quit()
...
def extract_and_write_flair_c1(segmentation_image, ni):
   """
...
def extract_and_write_fet_image(fet_image, tum_c1, ni):
   """
